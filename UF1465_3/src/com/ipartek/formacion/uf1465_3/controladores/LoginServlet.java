package com.ipartek.formacion.uf1465_3.controladores;
...
import com.ipartek.formacion.uf1465_3.accesodatos.UsuarioDao;
import com.ipartek.formacion.uf1465_3.accesodatos.UsuarioDaoMySql;
import com.ipartek.formacion.uf1465_3.bibliotecas.Password;
...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LOG.info(hash);
 		...
 		if (usuario != null && hash.equals(usuario.getPassword())) {
			request.getSession().setAttribute("usuario", usuario);
			
			request.getRequestDispatcher("/WEB-INF/vistas/saludo.jsp").forward(request, response);
			response.sendRedirect(request.getContextPath() + "/saludo");
