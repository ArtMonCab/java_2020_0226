...
INSERT INTO `clientes` VALUES (1,'Javier','Lete','12345678Z','1990-01-01'),(2,'Pepe','Pérez','87654321A','1992-02-02'),(5,'Yepa','Yepez','13243546G','1993-03-03'),(6,'Juan','Juanes','12345679S','1994-04-04');
...
INSERT INTO `historicos` VALUES (1,'clientes','Se ha insertado un cliente nuevo','2021-01-13 09:54:10'),(2,'clientes','Nuevo cliente: Juan Juanes','2021-01-13 09:57:19');
...
CREATE TABLE `movimientos` (
  ...
  CONSTRAINT `fk_cuentas_clientes1` FOREIGN KEY (`clientes_id`) REFERENCES `clientes` (`id`)
...
INSERT INTO `movimientos` VALUES (4,500.00,1),(5,300.00,2),(6,-100.00,2),(7,-123.00,1),(8,123.00,2),(9,-67.00,1),(15,-21.00,1),(16,21.00,2);
...
CREATE TABLE `productos` (
  ...
  `url_imagen` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (1,'javier@lete.com','javier',NULL),(2,'pepe@perez.com','pepe',NULL),(3,'nuevo@nuevez.com','nuevo',NULL),(4,'nuevo2@nuevez.com','nuevo2',NULL),(5,'nuevo3@nuevez.com','nuevo3',NULL),(7,'nuevo3@nuevez.com','nuevo3',NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `login`(IN p_email VARCHAR(45), IN p_password VARCHAR(45))
BEGIN
SELECT * FROM usuarios WHERE email = p_email AND password = p_password;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `transferencia`(IN cliente_origen INT, IN cliente_destino INT, IN importe DECIMAL(12,2))
BEGIN
...
START TRANSACTION;
INSERT INTO movimientos (clientes_id, importe) VALUES (cliente_origen, -importe);
INSERT INTO movimientos (clientes_id, importe) VALUES (cliente_destino, importe);
COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `verificar_login` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `verificar_login`(IN p_email VARCHAR(45), IN p_password VARCHAR(45), OUT valido BOOLEAN)
BEGIN

DECLARE num INT;

SELECT COUNT(*) FROM usuarios WHERE email = p_email AND password = p_password INTO num;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productos_departamentos` AS select `p`.`id` AS `id_producto`,`p`.`nombre` AS `nombre_producto`,`p`.`descripcion` AS `descripcion_producto`,`p`.`url_imagen` AS `url_imagen`,`p`.`precio` AS `precio`,`p`.`descuento` AS `descuento`,`p`.`unidad_medida` AS `unidad_medida`,`p`.`precio_unidad_medida` AS `precio_unidad_medida`,`p`.`cantidad` AS `cantidad`,`d`.`id` AS `id_departamento`,`d`.`nombre` AS `nombre_departamento`,`d`.`descripcion` AS `descripcion_departamento` from (`productos` `p` join `departamentos` `d` on((`p`.`departamentos_id` = `d`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-01-15 11:02:49