...
INSERT INTO `alumno` VALUES (0,'alumno','sin asignar',NULL,NULL,NULL,00000,0,'aaaaaaa@aaaaa.com','0000000x',0,0),(1,'sergio','aparicio vargas','1977-12-01','','',00000,944110293,'aaaa@aaaa.com','44974398z',0,1),(2,'maite','monasterio','1986-11-11','','',48007,944110293,'mmonasterio@gmail.com','16071559x',0,1),(4,'enrique javier','ruiz jimenez','2017-02-14','','',00048,944110239,'enrique@gmail.com','45677362y',0,1),(5,'Perico','De Los Palotes','2000-01-01',NULL,NULL,48920,944110240,'periko@delospalotes.com','16055382W',1,1),(6,'Jaimito','De Los Palotes','2002-01-01',NULL,NULL,48920,944110240,'jaimito@delospalotes.com','123456789',1,1),(7,'Guybrush','Threepwood','1667-01-06',NULL,'Isla Mêlée',55555,555756759,'guybrush@piratas.com','987654321',1,0),(8,'Lechuck','El  Pirata','1665-01-06',NULL,NULL,55555,555756760,'lechuck@piratas.com','123456790',0,1);
...
CREATE TABLE `resenya` (
  ...
  `curso_codigo` int NOT NULL,
  PRIMARY KEY (`codigo`),
  KEY `fk_resenya_alumno1_idx` (`alumno_codigo`),
  KEY `fk_resenya_curso1_idx` (`curso_codigo`),
  CONSTRAINT `fk_resenya_alumno1` FOREIGN KEY (`alumno_codigo`) REFERENCES `alumno` (`codigo`),
  CONSTRAINT `fk_resenya_curso1` FOREIGN KEY (`curso_codigo`) REFERENCES `curso` (`codigo`)
...
INSERT INTO `resenya` VALUES (1,'Recomendable','2020-01-01',1,1),(2,'Demasiado generi','2020-02-01',1,2),(3,'Muy bueno','2020-03-01',1,8),(4,'Demasiado nivel para mi','2020-03-02',7,1),(5,'No me he enterado de nada','2020-03-02',7,8),(6,'Muy completo y util para el mundo laboral','2020-02-01',5,1),(7,'Demasiado básico','0000-00-00',8,7);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `cliente_resenya` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cliente_resenya`(IN `curso_codigo` INT)
BEGIN
	SELECT COUNT(codigo)
	FROM resenya
...
-- Dump completed on 2021-03-12  8:45:46
